...
die_2 = Die(10) #create another instance of a die with 10 sides
results = []  #create and empty list to store results
for roll_num in range(50_000):  #roll the dice 50,000 times
...
"""Visualize Results of Rolling a D6 and a D10 dice 50,000 Times"""
